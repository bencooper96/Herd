    ...
    <Box my={8}>
      ...
      <List spacing={5}>
        ...
        <ListItem>
          ...
          <Text textStyle="body">
            We all want better schools, better jobs, and safer neighborhoods.
            The first step to making strides on any of these goals is to open
            the difficult conversations about how we get there.{" "}
            <chakra.strong textStyle="bold">
